...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('image/bmi_mini_logo.png') }}" type="image/x-icon">
    ...
    {{-- Flat Picker --}}
    <link rel="stylesheet" href="{{ asset('dashboard/vendors/libs/flatpickr/flatpickr.css') }}" />
...
<body>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5 " href="{{ route('home') }}"><img
                        src="{{ asset('image/bmi_logo.png') }}" class="mr-2"
                        alt="logo"style="object-fit:cover" /></a>
                <a class="navbar-brand brand-logo-mini ml-2" href="{{ route('home') }}" style="object-fit:cover "><img
                        src="{{ asset('image/bmi_mini_logo.png') }}" alt="logo"
                        style="width: 72px; height: 56px; margin-left: 10px;" /></a>
            </div>
    ...
    <script src="{{ asset('dashboard/vendors/libs/flatpickr/flatpickr.js') }}"></script>
