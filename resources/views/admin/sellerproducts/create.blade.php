...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.seller-product.store') }}" enctype="multipart/form-data"
                id="myForm">
                @csrf
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            type="datetime-local" name="order_date" id="order_date"  value="{{ old('order_date') }}">
