...
@section('content')
    <div class="card">
        <div class="custom-header">
            <h5 class=" font-weight-bold ">  {{ trans('cruds.product_category.title_singular') }} {{ trans('global.list') }}</h5>
            <div>
                                ...
                                <td>
                                    ...
                                    @can('product_category_show')
                                        <a class="p-0 glow btn btn-primary text-white" 
                                            ...
                                            title="view" href="{{ route('admin.product-category.restore.trash', $product_category->id) }}">
                                            Restore 
                                        </a>
                                    @endcan
                                    @can('product_category_delete')
                                        <form id="orderDelete-{{ $product_category->id }}"
                                            action="{{ route('admin.product-category.trashDelete', $product_category->id) }}" method="POST"
