...
@section('content')
    <div class="card">
        ...
        <div class="card-body mt-4">
            <form method="POST" action="{{ route('admin.seller-type.update',[$seller_type->id])}}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $seller_type->name) }}">
