...
<body>
  <div class="container aligen-center mt-5">
    <div class="row">
        <div class="col-md-6">
            <h4>Spatie Media</h4>
    ...
    <script>
        Dropzone.options.studentPhotoDropzone = {
            ...
            success: function(file, response) {
                $('form').find('input[name="student_photo"]').remove()
                $('form').append('<input type="hidden" name="student_photo" value="' + response.name + '">')
            },
            ...
            init: function() {
                @if (isset($student) && $student->student_photo)
                    var file = {!! json_encode($student->student_photo) !!}
                    this.options.addedfile.call(this, file)
                    this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
                    file.previewElement.classList.add('dz-complete')
                    $('form').append('<input type="hidden" name="student_photo" value="' + file.file_name + '">')
                    this.options.maxFiles = this.options.maxFiles - 1
                @endif
            },
